...
import { sendChatMessage, type ChatMessage, type ChatContextData } from "@/lib/chat"
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md h-[600px] max-h-[80vh] flex flex-col border border-slate-200">
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-slate-900">Learning Assistant</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {messages.map((message) => (
            <div key={message.id} className={cn("flex gap-3", {
