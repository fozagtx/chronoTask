  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ zIndex: 10 }}
      >
        <p className="text-sm text-slate-700 font-medium leading-relaxed" style={{ fontFamily: 'cursive' }}>
      ...
      <div 
        className="absolute top-64 left-4 lg:left-12 xl:left-28 w-12 h-12 bg-[#2563EB] rounded-xl shadow-lg flex items-center justify-center rotate-[2deg] animate-float-in-delay-2 hover:shadow-xl hover:scale-[1.02] transition-all duration-200"
        style={{ zIndex: 15 }}
      >
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="font-semibold text-slate-900 text-sm font-heading">Reminders</span>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-400 pl-3.5">Call with marketing team</p>
        </div>
      ...
      >
        <div className="w-10 h-10 border-2 border-slate-300 rounded-full flex items-center justify-center relative">
          <div className="absolute w-0.5 h-3 bg-slate-700 origin-bottom rotate-[30deg]" style={{ bottom: '50%' }} />
          <div className="absolute w-0.5 h-2 bg-red-500 origin-bottom rotate-[120deg]" style={{ bottom: '50%' }} />
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span className="font-semibold text-slate-900 text-sm font-heading">Today&apos;s tasks</span>
        </div>
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <div className="w-5 h-5 bg-red-100 rounded flex items-center justify-center text-xs text-red-600 font-medium">1</div>
            ...
            <div className="flex items-center gap-1">
              <div className="w-16 h-1.5 bg-slate-200 rounded-full overflow-hidden">
                <div className="w-3/5 h-full bg-[#2563EB] rounded-full" />
              </div>
              <span className="text-xs text-slate-400">60%</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-5 h-5 bg-green-100 rounded flex items-center justify-center text-xs text-green-600 font-medium">3</div>
            <div className="flex-1">
      ...
      <div 
        ...
        style={{ zIndex: 10 }}
      >
        <span className="font-semibold text-slate-900 text-sm font-heading">100+ Integrations</span>
        <div className="flex items-center gap-3 mt-3">
          ...
          <div className="w-10 h-10 bg-white rounded-lg shadow-sm flex items-center justify-center">
            <svg viewBox="0 0 24 24" className="w-6 h-6">
              <path fill="#4285F4" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14H7v-2h5v2zm5-4H7v-2h10v2zm0-4H7V7h10v2z"/>
            </svg>
          </div>
        </div>
      </div>
